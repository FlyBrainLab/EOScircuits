...
)
{
    ...
    for (int nid = tid; nid < num_thread; nid += total_threads) {
        ...
        /* import data */
        states.r = g_state_r[nid];
        double param_THRESHOLD = g_param_threshold[nid];
        double input_I = g_input_I[nid];

        
        
        /* compute gradient */
        ode(states, gstates, param_THRESHOLD, input_I);
        ...
        g_state_r[nid] = states.r;

        /* export output (updates) data */
        g_output_r[nid] = states.r;
    }
